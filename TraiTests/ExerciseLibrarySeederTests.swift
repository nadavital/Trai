...
final class ExerciseLibrarySeederTests: XCTestCase {
    ...
    func testExerciseCategoryNormalizationAcceptsUserFacingActivityNames() {
        ...
        XCTAssertNil(Exercise.Category.normalized(from: "Trunk Rotation"))
        ...
        XCTAssertEqual(Exercise.defaultActivityTypeName(for: "Trunk Rotation", category: .custom), "Trunk Rotation")
